...
import { IApiResponse, IBaseEntity, IDeactReact, IPersistResponse } from '@app/shared/service/model'
...
export abstract class BaseService<T extends IBaseEntity> {
  ...
  public delete(data: { id: string; updatedAt?: Date | string }): Observable<IPersistResponse> {
    if (!data) {
      return throwError(() => new Error('Null or undefined context data'))
    }
